...
\section{Revision history}
	Revisions will also be marked in the MIS and MID in \textcolor{red}{red} regarding changes and or deletions in the module specifically
	\subsection{Board}
	\begin{itemize}
	\item nothing
	\end{itemize}
    ...
    \subsubsection{Interface}
        \begin{tabularx}{\linewidth}{@{} >{\bfseries}r Xp{5cm} }
            ...
            Access Programs & \begin{tabular}[t]{@{} p{4cm} p{8cm}}
                                    ...
                                    & \\
                                    canJump() & Retrieves whether there is a jump in any direction. \\
                              \end{tabular}
        \end{tabularx}
    ...
    \subsubsection{Implementation}
        \begin{longtabu}{ >{\bfseries}r Xp{2cm} }
            Variables       & \begin{tabular}[t]{@{} l p{8cm}} 
                                    ...
                                    isAJump : bool & holds whether or not a jump is available \\
                              \end{tabular} \\
            ...
            Access Programs & \\
                            ...
                            & \begin{tabular}[t]{@{} p{4cm} p{8cm}}
                                ...
                                Updates & None \\ 
                                Outputs &  None\\
                                Description & returns true if any directions have a jump availabe, otherwise returns false.\\
                                 & \\  
                            \end{tabular} \\
        \end{longtabu}
    ...
    \subsubsection{Implementation}
        \begin{longtabu}{ >{\bfseries}r Xp{2cm} }
            ...
            Variables       & \begin{tabular}[t]{@{} l p{8cm}} 
                                    ...
                                    numPieces : int & holds the number of pieces. \\
                                    jumpingPiece : Piece & saves the piece that is currently jumping. \\
                                    jumpAvailable : bool[] & holds whether or not a jump can be mad and by which player. \\
                              \end{tabular} \\
            Access Programs & \\
