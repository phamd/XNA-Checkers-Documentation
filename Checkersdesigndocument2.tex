...
\section{Requirements of Checkers}
	...
	\item Assignment 2 Requirements	
		\begin{enumerate}[label*=\arabic*.]
		\item Load Saves and legal moves checking
			\begin{enumerate}[label*=\arabic*.]
				...
				\item \CustomLabel{req:2.1.3}Make moves from one position to another, while making sure the move made is legal
				\item \CustomLabel{req:2.1.4}Save a game to be resumed later
			\end{enumerate}
		\end{enumerate}
	\end{enumerate}
