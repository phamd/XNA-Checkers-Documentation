...
\section{Requirements of Assignment 2}
	\begin{enumerate}
	\item \CustomLabel{req:1.1}
	Start Game from original starting positions
	\item \CustomLabel{req:1.2}
	Start a game from a previously stored state from a within a file
	\item \CustomLabel{req:1.3}Make moves from one position to another, while making sure the move made is legal
	\item \CustomLabel{req:1.4}Save a game to be resumed later
	\end{enumerate}
...
\subsection{Software Decision Hiding Module}
    ...
    \subsubsection{FileIO Module}\CustomLabel{mod:LoadSave}
        \begin{tabularx}{\linewidth}{ >{\bfseries}r X }
            ...
            Requirements & 1.\ref{req:1.1} 1.\ref{req:1.2} 1.\ref{req:1.3} 1.\ref{req:1.4}\\
