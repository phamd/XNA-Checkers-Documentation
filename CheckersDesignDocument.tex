...
\fi
    ...
    \subsubsection{Input Module}\CustomLabel{mod:Piece}
    ...
    \subsubsection{Implementation}
        \begin{tabularx}{\linewidth}{ >{\bfseries}r Xp{5cm} }
            ...
            Access Programs & \begin{tabular}[t]{@{} p{4cm} p{7cm}} 
                                    ...
                                    Outputs & pieceArray[] \\
                                    Updates & None \\
                                    Desc    & Parses input to be interpreted as Piece locations. Place Piece on correct Piece location using the PlacePiece() access program.\\
                                     & \\
                                    ...
                                    Outputs & pieceArray[] \\
                                    Updates & None \\ 
                                    Desc    & If piece placement is valid, it will put it there in the data structure. \\
                                     & \\
